...
export function initMenuToggle() {
  ...
  function animateHamburger(opening) {
    if (opening) {
      barTop.classList.add('rotate-60', 'translate-y-[6px]');
      barMiddle.classList.add('opacity-0');
      barBottom.classList.add('-rotate-60', '-translate-y-[6px]');
    } else {
      barTop.classList.remove('rotate-60', 'translate-y-[6px]');
      barMiddle.classList.remove('opacity-0');
      barBottom.classList.remove('-rotate-60', '-translate-y-[6px]');
    }
  }
